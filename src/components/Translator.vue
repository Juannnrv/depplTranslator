<template>
  <div class="h-screen w-screen flex self-center items-center">
    <div class="p-6 max-w-lg mx-auto bg-white rounded-lg shadow-md">
      <h1 class="text-2xl font-bold mb-4 text-center">Traductor de Idiomas</h1>
  ...
  setup() {
    ...
    onMounted(async () => {
      try {
        ...
        errorMessage.value =
          "Error al cargar los idiomas. Por favor, recarga la página.";
      } finally {
    ...
    const handleTranslate = async () => {
      ...
      if (!canTranslate.value) {
        errorMessage.value =
          "Por favor, completa todos los campos y asegúrate de que los idiomas de origen y destino sean diferentes.";
        return;
      }
      ...
      try {
        ...
        translatedText.value =
          translation.data?.translations?.translatedText ||
